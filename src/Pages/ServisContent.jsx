  ...
  return (
    <div className=''>
      <div className="border-b border-[#302F2F] flex flex-col justify-evenly w-[100%] h-[570px]">
        ...
        <div className="flex flex-col w-[100%] h-[250px]  gap-3 ">
          ...
          <div className="flex flex-col gap-2 content-center w-[970px]">
            {navbarServisCard.map((res) => {
              return (
                <div className="bg-[#302F2F] w-[100%] h-[100px] border rounded-md flex content-center justify-between px-4 py-2  items-center self-center ">
      ...
      <div className="flex flex-col gap-3 mt-5 bg-black">
        {servisCard.map((item) => {
          return (
            <div className="flex justify-between px-5 cflex  items-center self-stretch  content-center w-[100%] h-[100px] bg-lightBlack border rounded-md">
