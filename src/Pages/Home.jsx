  ...
  return (
    <div className="w-[100%] h-[100%] bg-black">
      <div className="bg-bleck h-[740px] flex flex-col justify-between">
        ...
        <Rodal
          className="backdrop-blur-sm w-[500px] h-[350px]"
          height={350}
          width={500}
          visible={ModalVisibled}
          onClose={() => setModalVisibled(false)}
        >
          <div className="bg-[#121212]  h-[320px] flex flex-col content-center gap-1 ">
            <div
              className={`flex flex-col gap-2 justify-start content-start  h-[100px]  p-2`}
            >
              <span className="w-[30%] text-[14px] leading-[15px] font-BeauSans  text-white">
                Enter your email address
              </span>
              <input
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="h-[35px] rounded-[5px] border-[#A7A7A7] outline-none "
                type="text"
                placeholder="Email....."
              />
            </div>
            ...
            >
              <span className="w-[50%] text-[14px] leading-[15px]  font-BeauSans text-base text-white">
                Enter your password
              </span>
              <input
                value={password}
            ...
            <p className="text-white flex justify-center border-b-[0.5px]  border-white">
              or
            </p>
