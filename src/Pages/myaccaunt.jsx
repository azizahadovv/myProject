...
const MyAccaunt = () => {
  return (
    <div className="flex flex-col gap-5 w-[107%] h-[100%]  snap-none">
          ...
          {countries.map((item) => {
            return (
              ...
              >
                ...
                {item.number.map((res) => {
                  return (
                    <div className="flex justify-between content-center  align-center h-[15px]">
                      <p
                        className={`${
      ...
      <div className="flex flex-col gap-5">
        <div className="h-[220px] w-[100%] flex flex-col gap-4  ">
          ...
          <div className="flex justify-between align-center content-center gap-2 flex-wrap">
            {card.map((item) => {
              return (
                <div className="relative w-[270px] h-[150px] bg-lightBlack rounded-md flex flex-col justify-center  content-center align-center text-center gap-4">
